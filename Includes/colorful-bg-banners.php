...
<div class="row no-gutters">
    ...
    <div class="col-12 col-md-4 pr-2 pr-lg-3">
        <div class="bg-green rounded-10 h-100">
            ...
            <section class="text-white text-center px-2">
                ...
                <p class="m-0 pb-3 px-lg-3">över 30 olika märken av djurfoder för hund, katt och smådjur</p>
            </section>
        </div>
    </div><!-- End icon set -->
    <!-- Icon set -->
    <div class="col-12 col-md-4 pr-2 pr-lg-3">
        <div class="bg-info rounded-10 h-100">
            ...
            <section class="text-white text-center px-2">
                ...
                <p class="m-0 pb-3 px-lg-3">ett stort sortiment leksaker och godis som gör livet roligare för dig och dina
                    husdjur</p>
            </section>
        </div>
    </div><!-- End icon set -->
    ...
    <div class="col-12 col-md-4">
        <div class="bg-orange rounded-10 h-100">
            <picture>
                <img class="pt-3 m-auto d-block img-fluid px-2" sizes="(max-width: 250px) 100vw, 250px"
            ...
            <section class="text-white text-center px-2">
                <h3 class="m-0">Skötsel & Tillbehör</h3>
                <p class="m-0 pb-3 px-lg-3">ett stort utbud skötsel och tillbehör för din fyrbenta familjemedlem</p>
            </section>
        </div>
    </div><!-- End icon set -->
