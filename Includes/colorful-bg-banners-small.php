<!-- colorful bg small banner container -->
<div class="container m-0 p-0">
<div class="row no-gutters">
    <!-- Icon set -->
    <div class="col-12 col-md-4 px-md-2 pl-lg-0">
    ...
    <!-- Icon set -->
    <div class="col-12 col-md-4 px-md-2 pr-lg-0">
...
</div><!-- End of colorful bg small banner row -->
</div><!-- End of colorful bg small banner container -->